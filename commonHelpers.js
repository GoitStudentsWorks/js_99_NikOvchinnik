import{g as k,i as W,a as j,b as K,c as i,d as L,e as y,f as w,s as f,r as p,h as C,j as S}from"./assets/scroll-up-588c2fca.js";import{b as O}from"./assets/vendor-a536f886.js";const{bookIdsLSKey:b}=p,d={};async function z(o){const t=o.target.closest("li");if(t)try{let h=function(c){c.key==="Escape"&&m.close()};const e=t.dataset.bookId,r=(await k(e)).data,{book_image:n,title:a,author:l,description:A,buy_links:M}=r,[_,I]=M,q=`<div class="modal-window">
